 ...
 */
public class empleadoFormulario extends javax.swing.JDialog {
     ...
     */
    public empleadoFormulario(java.awt.Frame parent, boolean modal, vistaEmpleados vista) {
        super(parent, modal);
        this.vista = vista;
        initComponents();
    ...
    public void cargarDatosJTextField(int Id_Empleado, String Cedula, String Nombre1, String Nombre2, String Apellido1, String Apellido2, String Direccion, String Email) {
        ...
        jTextFieldId.setText(String.valueOf(Id_Empleado));
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanelInferiorFormulario, javax.swing.GroupLayout.PREFERRED_SIZE, 650, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        if (Cedula.isEmpty() || Nombre1.isEmpty() || Nombre2.isEmpty() || Apellido1.isEmpty()
                || Apellido2.isEmpty()|| Direccion.isEmpty() || Email.isEmpty()) {
        ...
        try {
           /* java.sql.Date fechaSQL = new java.sql.Date(Apellido2.getTime());*/
            ...
            controlador.crearEmpleado(Cedula, Nombre1, Nombre2, Apellido1, Apellido2, Direccion, Email);
